...
Button(root, text="AC", command=clear_all).grid(row=4, column=1)
...
Button(root, text="Pi", command=lambda: get_variable("*3.14")).grid(row=2, column=4)
Button(root, text="Exp", command=lambda: get_variable("**")).grid(row=3, column=4)
Button(root, text="x!", command=lambda: get_variable(1)).grid(row=4, column=4)
Button(root, text="^2", command=lambda: get_variable(1)).grid(row=1, column=5)

Button(root, text="(", command=lambda: get_variable('(')).grid(row=2, column=5)
Button(root, text=")", command=lambda: get_variable(')')).grid(row=3, column=5)
Button(root, text="<-", command=undo).grid(row=4, column=5)
